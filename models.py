...
class BooksRatings(models.Model):
    user = models.ForeignKey('BooksUsers', models.DO_NOTHING, to_field=None)
    isbn = models.ForeignKey(BooksData, models.DO_NOTHING, db_column='ISBN', to_field=None)  # Field name made lowercase.
    rating = models.TextField()  # This field type is a guess.

    class Meta:
        managed = False
        db_table = 'books_ratings'
